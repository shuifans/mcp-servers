"""``read_cloud_doc`` tool implementation."""
...
async def read_cloud_doc(
    ...
    *,
    ...
    """Read a single cloud provider doc page, with cache and scrape fallback.
    ...
    if own_cache:
        ...
        cache_inst = DocCache(cache_path=cache_path)
    else:
        cache_inst = cache  # type: ignore[assignment]
