...
MCP (Model Context Protocol) Server 集合，用于搜索和阅读云服务商官方文档。基于 [IQS (Intelligent Query Service)](https://bailian.console.aliyun.com/) API 实现文档检索、全文读取和证据提取。
...
- Python >= 3.10
- IQS API Key（[申请地址](https://bailian.console.aliyun.com/)）
